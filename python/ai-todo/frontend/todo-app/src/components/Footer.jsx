...
const Footer = () => {
  return (
    <footer className="bg-gray-900/50 border-t border-gray-700/50 py-12 mt-16 backdrop-blur-sm">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              Smart task management powered by artificial intelligence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">AI Categorization</a></li>
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">Smart Prioritization</a></li>
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">Productivity Insights</a></li>
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">Voice Commands</a></li>
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">Team Collaboration</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-500 hover:text-gray-300 transition-colors text-sm">Contact</a>
          </div>
        </div>
      </div>
    </footer>
